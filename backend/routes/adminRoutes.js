...
router.patch("/disputes/:id/resolve",             ...adminOnly, resolveDispute);
router.patch("/disputes/:id/reject",              ...adminOnly, rejectDispute);
router.post("/disputes/:id/request-info",         ...adminOnly, requestMoreInfo);
