          ...
          <div className="bg-card border border-border rounded-2xl p-12 shadow-sm">
            ...
            <div className="bg-muted/50 border border-border rounded-lg p-6 mb-8">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                You'll receive access once your account has been verified by an administrator.
              </p>
            ...
            <div className="space-y-3 text-left mb-8">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Our administrators will review your submitted documents
                  </p>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Once verified, you'll receive full access to AgroBridge
                  </p>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    After approval, you can begin listing or purchasing paddy
                  </p>
