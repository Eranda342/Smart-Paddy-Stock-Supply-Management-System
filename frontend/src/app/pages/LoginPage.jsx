...
export default function LoginPage() {
  ...
  // ── Google OAuth: redirect to backend, which starts the OAuth flow ──────
            ...
            <div className="bg-white/[0.03] border border-white/[0.08] backdrop-blur-2xl rounded-3xl p-8 sm:p-10 shadow-2xl relative overflow-hidden">
              ...
              <div className="mt-6">
                <button
                  ...
                  className="w-full py-3 px-4 bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 text-white rounded-xl font-medium transition-all flex items-center justify-center gap-3 disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {googleLoading ? (
                    <>
