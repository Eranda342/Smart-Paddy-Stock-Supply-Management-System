...
export default function RoleSelectionPage() {
  ...
  const handleRoleSelect = (role) => {
    // Store role in sessionStorage for later steps
      ...
      <div className="flex items-center justify-center px-12 py-16">
        <div className="w-full max-w-3xl">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-semibold mb-3">How will you use AgroBridge?</h1>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            >
              ...
              <h2 className="text-2xl font-semibold mb-3">Farmer</h2>
              <p className="text-muted-foreground mb-4">
                List your paddy harvests, negotiate with rice mill owners, and manage your sales
              </p>
            ...
            {/* Rice Mill Owner Card */}
            <button
              onClick={() => handleRoleSelect('mill-owner')}
              className="bg-card border-2 border-border hover:border-[#22C55E] rounded-2xl p-10 text-left transition-all duration-200 hover:shadow-lg group"
            >
              <div className="w-16 h-16 bg-[#22C55E]/10 group-hover:bg-[#22C55E]/20 rounded-xl flex items-center justify-center mb-6 transition-colors">
                <Building2 className="w-8 h-8 text-[#22C55E]" />
              </div>
              <h2 className="text-2xl font-semibold mb-3">Rice Mill Owner</h2>
              <p className="text-muted-foreground mb-4">
                Browse paddy listings, negotiate with farmers, and manage procurement logistics
              </p>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 bg-[#22C55E] rounded-full"></div>
