      ...
      <div className="max-w-[1320px] mx-auto px-[60px] py-20">
        ...
        <div className="grid grid-cols-4 gap-6">
          <div className="bg-card border border-border rounded-2xl p-6 hover:shadow-lg transition-shadow duration-200">
            ...
            <p className="text-muted-foreground">Admin-verified accounts ensure trusted transactions between parties</p>
          </div>
          <div className="bg-card border border-border rounded-2xl p-6 hover:shadow-lg transition-shadow duration-200">
            <div className="w-12 h-12 bg-[#22C55E]/10 rounded-xl flex items-center justify-center mb-4">
            ...
            <p className="text-muted-foreground">Communicate directly with buyers and sellers for better deals</p>
          </div>
          <div className="bg-card border border-border rounded-2xl p-6 hover:shadow-lg transition-shadow duration-200">
            <div className="w-12 h-12 bg-[#22C55E]/10 rounded-xl flex items-center justify-center mb-4">
            ...
            <p className="text-muted-foreground">Clear pricing structure with real-time market information</p>
          </div>
          <div className="bg-card border border-border rounded-2xl p-6 hover:shadow-lg transition-shadow duration-200">
            <div className="w-12 h-12 bg-[#22C55E]/10 rounded-xl flex items-center justify-center mb-4">
            ...
            <p className="text-muted-foreground">Streamlined logistics and delivery management</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-muted py-20">
        <div className="max-w-[1320px] mx-auto px-[60px]">
          ...
          <div className="grid grid-cols-4 gap-8">
            {[
              { step: '01', title: 'Register', desc: 'Create your account as a Farmer or Rice Mill Owner' },
              { step: '02', title: 'Get Verified', desc: 'Submit required documents for admin verification' },
              { step: '03', title: 'Trade Paddy', desc: 'List or browse paddy harvests and negotiate prices' },
              { step: '04', title: 'Arrange Transport', desc: 'Coordinate delivery and complete the transaction' }
            ].map((item) => (
