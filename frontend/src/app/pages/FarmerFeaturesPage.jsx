...
import { ArrowLeft, ArrowRight, Sprout, Handshake, MessageSquare, ListPlus } from "lucide-react";

export default function FarmerFeaturesPage() {
  const sections = [
    {
      title: "Create Listings",
      desc: "List your harvest with quantity and pricing in seconds.",
      icon: ListPlus
    },
    {
      title: "Receive Offers",
      desc: "Get offers from multiple mill owners and choose the best deal.",
      icon: Sprout
    },
    {
      title: "Negotiate",
      desc: "Chat and negotiate prices in real-time.",
      icon: MessageSquare
    },
    {
      title: "Manage Transactions",
      desc: "Track deals, payments, and delivery status.",
      icon: Handshake
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#020617] via-[#020617] to-[#0f172a] text-white">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-24">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl font-black tracking-tight mb-6">For Farmers</h1>
          <p className="text-xl text-white/60 leading-relaxed max-w-2xl mx-auto">
            Sell your paddy easily and connect with verified mill owners.
          </p>
        </div>
